...
// Triggers
var TriggerRegister = Java.type(
    "com.chattriggers.ctjs.engine.langs.js.JSRegister").INSTANCE;
var TriggerResult = Java.type(
    "com.chattriggers.ctjs.triggers.OnTrigger.TriggerResult");
...
var Tessellator = Java.type(
    "com.chattriggers.ctjs.minecraft.libs.Tessellator").INSTANCE;
...
var XMLHttpRequest = Java.type(
    "com.chattriggers.ctjs.engine.langs.js.JSXMLHttpRequest");

// Objects
var Display = Java.type("com.chattriggers.ctjs.engine.langs.js.JSDisplay");
var DisplayLine = Java.type(
    "com.chattriggers.ctjs.engine.langs.js.JSDisplayLine");
var DisplayHandler = Java.type(
...
var Inventory = Java.type(
    "com.chattriggers.ctjs.minecraft.wrappers.objects.inventory.Inventory");
var TabList = Java.type("com.chattriggers.ctjs.minecraft.wrappers.TabList");
var Scoreboard = Java.type(
    "com.chattriggers.ctjs.minecraft.wrappers.Scoreboard");
var CPS = Java.type("com.chattriggers.ctjs.minecraft.wrappers.CPS");
var Item = Java.type(
    "com.chattriggers.ctjs.minecraft.wrappers.objects.inventory.Item");
var Block = Java.type(
    "com.chattriggers.ctjs.minecraft.wrappers.objects.block.Block");
var Sign = Java.type(
    "com.chattriggers.ctjs.minecraft.wrappers.objects.block.Sign");
var Entity = Java.type(
    "com.chattriggers.ctjs.minecraft.wrappers.objects.Entity");
var Action = Java.type(
    "com.chattriggers.ctjs.minecraft.wrappers.objects.inventory.action.Action");
var ClickAction = Java.type(
    "com.chattriggers.ctjs.minecraft.wrappers.objects.inventory.action.ClickAction");
var DragAction = Java.type(
    "com.chattriggers.ctjs.minecraft.wrappers.objects.inventory.action.DragAction");
var KeyAction = Java.type(
    "com.chattriggers.ctjs.minecraft.wrappers.objects.inventory.action.KeyAction");

// Triggers
var OnChatTrigger = Java.type("com.chattriggers.ctjs.triggers.OnChatTrigger");
var OnCommandTrigger = Java.type(
    "com.chattriggers.ctjs.triggers.OnCommandTrigger");
var OnRegularTrigger = Java.type(
    "com.chattriggers.ctjs.triggers.OnRegularTrigger");
var OnRenderTrigger = Java.type(
    "com.chattriggers.ctjs.triggers.OnRenderTrigger");
var OnSoundPlayTrigger = Java.type(
    "com.chattriggers.ctjs.triggers.OnSoundPlayTrigger");
...
// Misc
var Console = Java.type(
    "com.chattriggers.ctjs.engine.langs.js.JSLoader").INSTANCE.getConsole();
