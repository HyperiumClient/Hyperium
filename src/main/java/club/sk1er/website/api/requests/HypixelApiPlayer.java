...
public class HypixelApiPlayer implements HypixelApiObject {
  ...
  public double getsafTotalXP() {
    return ILeveling.getTotalExpToLevel(getRoot().optInt("oldLevel") + 1) + getRoot()
        .optInt(ILeveling.EXP_FIELD);
  }
  ...
  public boolean isStaff() {
    ...
    return rank.equalsIgnoreCase("admin") || rank.equalsIgnoreCase("moderator") || rank
  ...
  public Rank getRank() {
    return Rank.get(getRankForMod().toUpperCase(Locale.ENGLISH));
  }
