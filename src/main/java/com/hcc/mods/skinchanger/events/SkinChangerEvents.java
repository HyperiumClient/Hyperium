...
package com.hcc.mods.skinchanger.events;
...
public class SkinChangerEvents {
    ...
    private ResourceLocation getSkin(String name) {
        if (name != null && !name.isEmpty()) {
            ...
            File file1 = new File(new File(HCC.folder, "skins"), UUID.nameUUIDFromBytes(name.getBytes()).toString().substring(0, 2));
    ...
    protected ResourceLocation getOfCape(String name) {
        if (name != null && !name.isEmpty()) {
            ...
            File file1 = new File(new File(HCC.folder, "ofcape"), id);
