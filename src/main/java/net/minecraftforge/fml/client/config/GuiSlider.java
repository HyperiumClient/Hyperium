...
public class GuiSlider extends GuiButtonExt {
  ...
  public GuiSlider(int id, int xPos, int yPos, int width, int height, String prefix, String suf,
      double minVal, double maxVal,
      double currentVal, boolean showDec, boolean drawStr) {
    this(id, xPos, yPos, width, height, prefix, suf, minVal, maxVal, currentVal, showDec, drawStr,
        null);
  }
  ...
  public GuiSlider(int id, int xPos, int yPos, String displayStr, double minVal, double maxVal,
  ...
  protected void mouseDragged(Minecraft par1Minecraft, int par2, int par3) {
    if (visible) {
      ...
      drawRect(xPosition + (int) (sliderValue * (float) (width - 6)), yPosition,
          xPosition + (int) (sliderValue * (float) (width - 6)) + 6, yPosition + 20,
  ...
  public void updateSlider() {
    ...
    if (showDecimal) {
      ...
      val = new StringBuilder(
          Integer.toString((int) Math.round(sliderValue * (maxValue - minValue) + minValue)));
    }
