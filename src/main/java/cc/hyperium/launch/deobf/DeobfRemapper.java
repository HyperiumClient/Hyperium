...
public final class DeobfRemapper extends Remapper {
  ...
  private DeobfRemapper() throws IOException {
        ...
        while ((line = bis.readLine()) != null) {
          ...
          switch (parts[0]) {
            ...
            case "MD:": {
              ...
              srgMethodNames.computeIfAbsent(obfOwner, f -> Maps.newHashMap())
                  .put(obfId, deobfName);
            ...
            case "FD:": {
              ...
              String deobfName = deobfNameAndOwner
                  .substring(deobfNameAndOwner.lastIndexOf('/') + 1);
              srgFieldNames.computeIfAbsent(obfOwner, f -> Maps.newHashMap())
    ...
    try (InputStream methodsCsv = getClass()
        .getResourceAsStream("/mappings/mc_1.8.9/methods.csv")) {
