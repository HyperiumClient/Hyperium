...
public class PatchManager {
  ...
  static {
    registerTransformers(
        ...
        new NoopTransformer("avh"),
        new NoopTransformer("bdb"),
        new NoopTransformer("bet"),
        new NoopTransformer("b"),
        new NoopTransformer("biu"),
        new NoopTransformer("bjg"),
        new NoopTransformer("avn"),
        new NoopTransformer("bec"),
        new NoopTransformer("aya"),
        new NoopTransformer("bfl"),
        new NoopTransformer("bmj"),
        new NoopTransformer("ayb"),
        ...
        new NoopTransformer("bmx"),
        new NoopTransformer("bma"),
        new NoopTransformer("avj"),
