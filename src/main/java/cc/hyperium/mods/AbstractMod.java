...
/**
 * A simple interface which allows a built-in mod to be turned on and off by the user
 */
public abstract class AbstractMod {
  ...
  /**
   * The Metadata implementation, created to identify built-in addons and their other information.
  ...
  public static class Metadata {
    ...
    public Metadata(AbstractMod mod, String name, String version, String author) {
      ...
      checkArgument(!StringUtils.isEmpty(version),
          "Version cannot be null or empty (" + version + ")");
