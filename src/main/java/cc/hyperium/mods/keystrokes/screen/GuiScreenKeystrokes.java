...
public class GuiScreenKeystrokes extends GuiScreen implements IScreen {
  ...
  public void initGui() {
    ...
    buttonList
        .add(buttonShowMouseButtons = new GuiButton(1, width / 2 + 5, calculateHeight(-1), 150, 20,
            "Show mouse buttons: " + (settings.isShowingMouseButtons() ? "On" : "Off")));

    buttonList
        .add(buttonShowSpacebar = new GuiButton(2, width / 2 - 155, calculateHeight(0), 150, 20,
    ...
    buttonList
        .add(buttonShowCPSOnButton = new GuiButton(4, width / 2 - 155, calculateHeight(1), 150, 20,
    ...
    buttonList
        .add(buttonKeyBackground = new GuiButton(9, width / 2 + 5, calculateHeight(3), 150, 20,
    ...
    buttonList
        .add(new GuiSliderFadeTime(mod, 13, width / 2 + 5, calculateHeight(5), 150, 20, this));
    ...
    buttonList
        .add(new GuiButton(16, width / 2 - 155, calculateHeight(7), 150, 20, "Edit Custom Keys"));
  ...
  public void drawScreen(int mouseX, int mouseY, float partialTicks) {
    ...
    drawCenteredString(mc.fontRendererObj,
        "Keystrokes v" + mod.getVersion() + " - Created by Sk1er LLC", width / 2, 5, 16777215);
  ...
  protected void actionPerformed(GuiButton button) {
    ...
    switch (button.id) {
      ...
      case 1:
        ...
        buttonShowMouseButtons.displayString =
            "Show mouse buttons: " + (settings.isShowingMouseButtons() ? "On" : "Off");
        updated = true;
        break;
      ...
      case 2:
        ...
        buttonShowSpacebar.displayString =
            "Show spacebar: " + (settings.isShowingSpacebar() ? "On" : "Off");
        updated = true;
        break;
      ...
      case 4:
        ...
        buttonShowCPSOnButton.displayString =
            "Show CPS on buttons: " + (settings.isShowingCPSOnButtons() ? "On" : "Off");
        updated = true;
        break;
      ...
      case 6:
        ...
        buttonRightClick.displayString =
            "Click Counter: " + (settings.isLeftClick() ? "Left" : "Right");
        updated = true;
        break;
      ...
      case 9:
        ...
        buttonKeyBackground.displayString =
            "Key background: " + (settings.isKeyBackgroundEnabled() ? "On" : "Off");
        updated = true;
        break;
      ...
      case 17:
        ...
        buttonLiteralKeys.displayString =
            "Literal Keys: " + (settings.isUsingLiteralKeys() ? "On" : "Off");
        updated = true;
        break;
  ...
  @Override
  protected void mouseClickMove(int mouseX, int mouseY, int lastButtonClicked,
