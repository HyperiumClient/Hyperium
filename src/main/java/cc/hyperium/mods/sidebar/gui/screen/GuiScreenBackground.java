...
public class GuiScreenBackground extends GuiScreenSidebar implements GuiScreenHelper {
  ...
  public void initGui() {
    buttonList.add(new GuiButton(0, getCenter() - 75, getRowPos(1), 150, 20,
        "Chroma: " + getSuffix(sidebar.chromaEnabled)));
    buttonList.add(buttonChromaType = new GuiButton(7, getCenter() - 75, getRowPos(2), 150, 20,
        "Chroma type: " + sidebar.chromaType.getName()));
    buttonList.add(
        sliderRed = new GuiSlider(1, getCenter() - 75, getRowPos(2), 150, 20, "Red: ", "", 0.0,
            255.0, sidebar.color >> 16 & 0xFF, false, true));
    buttonList.add(
        sliderGreen = new GuiSlider(2, getCenter() - 75, getRowPos(3), 150, 20, "Green: ", "", 0.0,
            255.0, sidebar.color >> 8 & 0xFF, false, true));
    buttonList.add(
        sliderBlue = new GuiSlider(3, getCenter() - 75, getRowPos(4), 150, 20, "Blue: ", "", 0.0,
            255.0, sidebar.color & 0xFF, false, true));
    buttonList.add(
        sliderAlpha = new GuiSlider(4, getCenter() - 75, getRowPos(5), 150, 20, "Alpha: ", "", 0.0,
            255.0, sidebar.alpha, false, true));
    buttonList.add(sliderChromaSpeed = new GuiSlider(3, getCenter() - 75, getRowPos(4), 150, 20,
        "Chroma Speed: ", "", 1.0, 10.0, sidebar.chromaSpeed, false, true));
  ...
  private void updateSettings() {
    sidebar.color = (sliderRed.getValueInt() << 16 | sliderGreen.getValueInt() << 8 | sliderBlue
        .getValueInt());
