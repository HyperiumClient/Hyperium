...
public class GuiScreenSettings extends GuiScreenSidebar implements GuiScreenHelper {
  ...
  public void initGui() {
    buttonList.add(new GuiButton(0, getCenter() - 75, getRowPos(1), 150, 20,
        "Sidebar: " + getSuffix(sidebar.enabled)));
    buttonList.add(new GuiButton(1, getCenter() - 75, getRowPos(2), 150, 20,
        "Red Numbers: " + getSuffix(sidebar.redNumbers)));
    buttonList.add(new GuiButton(2, getCenter() - 75, getRowPos(3), 150, 20,
        "Shadow: " + getSuffix(sidebar.shadow)));
    buttonList.add(new GuiButton(3, getCenter() - 75, getRowPos(4), 150, 20, "Change Background"));
    buttonList.add(
        sliderScale = new GuiSlider(4, getCenter() - 75, getRowPos(5), 150, 20, "Scale: ", "%",
            50.0, 200.0, Math.round(sidebar.scale * 100.0f), false, true));
  ...
  public void drawScreen(int mouseX, int mouseY, float partialTicks) {
    ...
    if (sliderScale.dragging) {
      sidebar.scale = sliderScale.getValueInt() / 100.0f;
    }
  }
