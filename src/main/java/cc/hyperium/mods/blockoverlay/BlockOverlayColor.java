...
public class BlockOverlayColor extends GuiScreen {
  ...
  public void initGui() {
    super.buttonList
        .add(buttonChroma = new GuiButton(0, super.width / 2 - 50, super.height / 2 - 60, 100, 20,
            "Chroma: " + (mod.getSettings().isChroma() ? "On" : "Off")));
    super.buttonList
        .add(sliderChroma = new GuiSlider(1, super.width / 2 - 50, super.height / 2 - 35, 100, 20,
            "Speed: ", "", 1, 5, mod.getSettings().getChromaSpeed(), false, true));
    super.buttonList
        .add(sliderRed = new GuiSlider(2, super.width / 2 - 50, super.height / 2 - 35, 100, 20,
            "Red: ", "", 0, 255, mod.getSettings().getOverlayRed() * 255, false, true));
    super.buttonList
        .add(sliderGreen = new GuiSlider(3, super.width / 2 - 50, super.height / 2 - 10, 100, 20,
            "Green: ", "", 0, 255, mod.getSettings().getOverlayGreen() * 255, false, true));
    super.buttonList
        .add(sliderBlue = new GuiSlider(4, super.width / 2 - 50, super.height / 2 + 15, 100, 20,
            "Blue: ", "", 0, 255, mod.getSettings().getOverlayBlue() * 255, false, true));
    super.buttonList
        .add(sliderAlpha = new GuiSlider(5, super.width / 2 - 50, super.height / 2 + 40, 100, 20,
            "Alpha: ", "", 0, 255, mod.getSettings().getOverlayAlpha() * 255, false, true));
    super.buttonList
        .add(buttonBack = new GuiButton(6, super.width / 2 - 50, super.height / 2 + 65, 100, 20,
            "Back"));
  }
    ...
    switch (button.id) {
      ...
      case 6:
        Hyperium.INSTANCE.getHandlers().getGuiDisplayHandler()
            .setDisplayNextTick(new BlockOverlayGui(mod));
        break;
    }
  }
