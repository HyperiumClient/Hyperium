...
public class BlockOverlayGui extends GuiScreen {
  ...
  public void initGui() {
    super.buttonList
        .add(buttonMode = new GuiButton(0, super.width / 2 - 50, super.height / 2 - 35, 100, 20,
            "Mode: " + mod.getSettings().getOverlayMode().getName()));
    super.buttonList
        .add(buttonColor = new GuiButton(1, super.width / 2 - 50, super.height / 2 - 10, 100, 20,
            "Color"));
    super.buttonList
        .add(sliderWidth = new GuiSlider(2, super.width / 2 - 50, super.height / 2 + 15, 100, 20,
  ...
  public void drawScreen(final int mouseX, final int mouseY, final float partialTicks) {
    ...
    super.drawCenteredString(super.fontRendererObj, "Block Overlay",
        Math.round(super.width / 2F / 1.2f), Math.round(super.height / 2F / 1.2f) - 50, -1);
  ...
  public void actionPerformed(final GuiButton button) {
    switch (button.id) {
      case 0:
        mod.getSettings()
            .setOverlayMode(BlockOverlayMode.getNextMode(mod.getSettings().getOverlayMode()));
