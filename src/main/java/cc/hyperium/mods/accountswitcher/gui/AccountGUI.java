...
public class AccountGUI extends GuiScreen {
    ...
    public void initGui() {
        ...
        buttonList.clear();
        // add them fields
        passwordField = new GuiTextField(0, mc.fontRendererObj, width >> 2, (height >> 1) + 20, width >> 1, 20);
        passwordField.setVisible(true);
        usernameField = new GuiTextField(1, mc.fontRendererObj, width >> 2, (height >> 1) - 20, width >> 1, 20);
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        drawCenteredString(mc.fontRendererObj, "Username", (width >> 2) + 24, (height >> 1) - 35, 0xffffff);
        drawCenteredString(mc.fontRendererObj, "Password", (width >> 2) + 24, (height >> 1) + 8, 0xffffff);
