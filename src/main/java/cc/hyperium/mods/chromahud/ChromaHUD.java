...
public class ChromaHUD extends AbstractMod {
  ...
  public AbstractMod init() {
    ...
    Hyperium.INSTANCE.getHandlers().getHyperiumCommandHandler()
        .registerCommand(new CommandChromaHUD(this));
    return this;
  }
  ...
  private void registerConfigElements() {
    ChromaHUDApi.getInstance()
        .registerButtonConfig("COORDS", new ButtonConfig((guiButton, displayItem) -> {
          CordsDisplay displayItem1 = (CordsDisplay) displayItem;
          displayItem1.state = displayItem1.state == 1 ? 0 : 1;
          guiButton.displayString =
              ChatColor.RED.toString() + "Make " + (((CordsDisplay) displayItem).state == 1
                  ? "Horizontal" : "Vertical");
        }, new GuiButton(0, 0, 0, "Coords State"),
            (guiButton, displayItem) -> guiButton.displayString = ChatColor.RED.toString() + "Make "
    ...
    ChromaHUDApi.getInstance()
        .registerButtonConfig("COORDS", new ButtonConfig((guiButton, displayItem) -> {
          ...
          guiButton.displayString =
              ChatColor.RED.toString() + "Change to " + next + " decimal" + (next != 1 ? "s" : "");
    ...
    ChromaHUDApi.getInstance()
        .registerButtonConfig("POTION", new ButtonConfig((guiButton, displayItem) -> {
        ...
        }, new GuiButton(0, 0, 0, "Potion Icons"),
            (guiButton, displayItem) -> guiButton.displayString =
                ChatColor.RED.toString() + "Toggle Potion Icon"));

    ChromaHUDApi.getInstance()
        .registerButtonConfig("DIRECTION", new ButtonConfig((guiButton, displayItem) -> {
        ...
        }, new GuiButton(0, 0, 0, "Short Directions"),
            ((guiButton, displayItem) -> guiButton.displayString =
                ChatColor.RED + "Toggle Short Direction")));

    ChromaHUDApi.getInstance()
        .registerButtonConfig("ARMOUR_HUD", new ButtonConfig((guiButton, displayItem) -> {
        ...
        }, new GuiButton(0, 0, 0, "Armour Hud Durability"),
            (guiButton, displayItem) -> guiButton.displayString =
                ChatColor.RED.toString() + "Toggle Durability"));
    ...
    ChromaHUDApi.getInstance()
        ...
        }, new GuiButton(0, 0, 0, "Armour Hud Hand"),
            (guiButton, displayItem) -> guiButton.displayString =
                ChatColor.RED.toString() + "Toggle Held Item"));
    ...
    ChromaHUDApi.getInstance()
        .registerButtonConfig("ARMOUR_HUD", new ButtonConfig((guiButton, displayItem) -> {
          ...
          guiButton.displayString = ChatColor.RED.toString() + "Toggle Armour On Top";
            ...
            (guiButton, displayItem) -> guiButton.displayString =
                ChatColor.RED.toString() + "Toggle Armour On Top"));
    ...
    ChromaHUDApi.getInstance()
        .registerButtonConfig("ARMOUR_HUD", new ButtonConfig((guiButton, displayItem) -> {
          ...
          guiButton.displayString =
              ChatColor.RED.toString() + "Make " + (((ArmourHud) displayItem).isHorizontal()
                  ? "Vertical" : "Horizontal");
        }, new GuiButton(0, 0, 0, "Armour Hud Direction"),
            (guiButton, displayItem) -> guiButton.displayString =
                ChatColor.RED.toString() + "Make " + (((ArmourHud) displayItem).isHorizontal()
                    ? "Vertical" : "Horizontal")));

    GuiTextField textTextField = new GuiTextField(1, Minecraft.getMinecraft().fontRendererObj, 0, 0,
        200, 20);
    ChromaHUDApi.getInstance().registerTextConfig("TEXT", new TextConfig(
        (guiTextField, displayItem) -> ((TextItem) displayItem).setText(guiTextField.getText()),
        textTextField,
        (guiTextField, displayItem) -> guiTextField.setText(((TextItem) displayItem).getText())));

    ChromaHUDApi.getInstance().registerTextConfig("TIME", new TextConfig(
        (guiTextField, displayItem) -> ((TimeHud) displayItem).setFormat(guiTextField.getText()),
        textTextField,
        (guiTextField, displayItem) -> guiTextField.setText(((TimeHud) displayItem).getFormat())));
    ...
    ChromaHUDApi.getInstance().registerButtonConfig("SCOREBOARD",
        new ButtonConfig((guiButton, displayItem) -> displayItem.getData().put("numbers",
            !displayItem.getData().optBoolean("numbers")), new GuiButton(0, 0, 0, "Toggle Number"),
            (guiButton, displayItem) -> {
            }));

    ChromaHUDApi.getInstance().registerTextConfig("SPRINT_STATUS",
        new TextConfig((guiTextField, displayItem) -> ((ToggleSprintStatus) displayItem)
            .setSprintEnabledText(guiTextField.getText()), textTextField,
            (guiTextField, displayItem) -> guiTextField
                .setText(((ToggleSprintStatus) displayItem).getStatusText())));

    ChromaHUDApi.getInstance()
        .registerButtonConfig("COINS", new ButtonConfig((guiButton, displayItem) -> {
