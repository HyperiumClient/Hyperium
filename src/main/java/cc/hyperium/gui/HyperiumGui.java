...
public abstract class HyperiumGui extends GuiScreen {
   ...
   * @param font           Font renderer to get width from, if null then default font renderer is
   *                       used
   * @param appendEllipsis Whether "..." should be appended to the end of the string before
   *                       returning
   * @return Trimmed string
   * @throws IllegalArgumentException If <code>width</code> is less than or equal to 0
   * @throws IllegalArgumentException if <code>str</code> is null or has a length less than or equal
   *                                  to 0
