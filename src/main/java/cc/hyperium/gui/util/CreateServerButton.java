...
public class CreateServerButton extends GuiScreen {
  ...
  public void drawScreen(int mouseX, int mouseY, float partialTicks) {
    ...
    if (serverName.getText().isEmpty()) {
      fontRendererObj
          .drawString(EnumChatFormatting.GRAY + I18n.format("gui.serverjoin.enterservername"),
              width / 2 - 96, height / 2 - 22, -1);
    }

    if (serverIp.getText().isEmpty()) {
      fontRendererObj
          .drawString(EnumChatFormatting.GRAY + I18n.format("gui.serverjoin.enterserverip"),
              width / 2 - 96, height / 2 + 2, -1);
    }
