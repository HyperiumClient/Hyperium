 ...
 * <p>
 * A more simple approach to the Scissor feature available with OpenGL-based libraries/dev kits.
 * Allows for you to use the GL Scissor method without the necessity of the Minecraft scaled res
 * factor.
 */
