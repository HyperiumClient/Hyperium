  ...
  private void addComponents() {
    ...
    infoTab.addChild(new ButtonComponent(this, new ArrayList<>(), "Capes",
        () -> Hyperium.INSTANCE.getHandlers().getGuiDisplayHandler()
            .setDisplayNextTick(new CapesGui())));
    ...
    for (String key : cosmeticCallback.getKeys()) {
      ...
      if (cosmetic.optBoolean("cape") || key.toLowerCase(Locale.ENGLISH).startsWith("particle")
          || cosmetic
      ...
      purchase
          .addChild(new LabelComponent(this, new ArrayList<>(), cosmetic.optString("description")));
      purchase.addChild(new ButtonComponent(this, new ArrayList<>(),
        ...
        if (cosmetic.optBoolean("purchased")) {
          Hyperium.INSTANCE.getHandlers().getGeneralChatHandler()
              .sendMessage("You have already purchased " + cosmetic.optString("name") + ".");
          return;
        }
