...
public class SelectorComponent extends AbstractTabComponent {
  ...
  public SelectorComponent(AbstractTab tab, List<String> tags, String label, Field field,
      Object parentObj, Supplier<String[]> values) {
    super(tab, tags);
    tag(label);
    this.label = label;
    this.field = field;
  ...
  public void render(int x, int y, int width, int mouseX, int mouseY) {
    ...
    lines.clear();
    lines = font.splitString(label, (int) (width - font
        .getWidth(getCurrentValue()))); //16 for icon, 3 for render offset and then some more
