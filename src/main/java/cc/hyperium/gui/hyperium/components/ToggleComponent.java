...
public class ToggleComponent extends AbstractTabComponent {
  ...
  public void render(int x, int y, int width, int mouseX, int mouseY) {
    ...
    lines.clear();
    lines = font
        .splitString(label, (width + 25) / 2); //16 for icon, 3 for render offset and then some more
    ...
    RenderUtils
        .drawSmoothRect((int) statX, y + 7, (int) (statX + 20), y + 10, 1, Color.WHITE.getRGB());
