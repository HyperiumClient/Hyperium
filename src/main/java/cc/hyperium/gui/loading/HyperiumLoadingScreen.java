...
public class HyperiumLoadingScreen {
    ...
    public static void renderHyperiumLoadingScreen(long systemTime, Framebuffer framebuffer, Minecraft mc, ScaledResolution scaledResolution, String currentlyDisplayedText, String message, int progress) {
        ...
        if (nanoTime - systemTime >= 100L) {
            ...
            mc.getTextureManager().bindTexture(new ResourceLocation("hyperium","textures/world-loading.png"));
