...
public class HyperiumDebug {
   ...
   */
  private final boolean debugHyperiumArgument = Boolean
      .parseBoolean(System.getProperty("hyperiumDebug", "false"));
  ...
  public void renderDebugOverlay(RenderHUDEvent event) {
    ...
    mc.fontRendererObj
        .drawStringWithShadow("memory usage: " + totalMemory + " / " + maxMemory + "MB", 3, 13, -1);
    mc.fontRendererObj
        .drawStringWithShadow("supported opengl ver: " + GL11.glGetString(GL11.GL_VERSION), 3, 23,
            -1);
    mc.fontRendererObj.drawStringWithShadow("cpu: " + OpenGlHelper.getCpu(), 3, 33, -1);
    mc.fontRendererObj
        .drawStringWithShadow("gpu: " + GL11.glGetString(GL11.GL_RENDERER), 3, 43, -1);
    mc.fontRendererObj
        .drawStringWithShadow("operating system: " + System.getProperty("os.name"), 3, 53, -1);
    mc.fontRendererObj
        .drawStringWithShadow("architecture type: " + System.getProperty("os.arch"), 3, 63, -1);
  }
}
