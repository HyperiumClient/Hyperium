  ...
  public void drawButton(Minecraft mc, int mouseX, int mouseY) {
    ...
    if (Settings.BUTTON_STYLE.equalsIgnoreCase("HYPERIUM 2")) {
      ...
      if (Settings.BUTTON_TYPE.equalsIgnoreCase("DEFAULT")) {
        ...
        this.drawBorderedRect(parent.xPosition, parent.yPosition, parent.xPosition + parent.getButtonWidth(), parent.yPosition + parentA.getHeight(), 1, parentA.isHovered() ? new Color(Settings.BUTTON_RED, Settings.BUTTON_GREEN, Settings.BUTTON_BLUE).getRGB() : textColor, color);
      }
    }
    int j = textColor;
    ...
    if (!enabled) {
      ...
      j = new Color(Settings.BUTTON_RED, Settings.BUTTON_GREEN, Settings.BUTTON_BLUE).getRGB();
    }
