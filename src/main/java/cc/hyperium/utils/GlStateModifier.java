...
public class GlStateModifier implements IGlStateModifier {
  ...
  public void setTexture(int id) {
    if (theArray == null) {
      try {
        theArray = (Object[]) ReflectionUtil
            .findField(GlStateManager.class, "textureState", "field_179174_p", "p").get(null);
      } catch (IllegalAccessException e) {
        e.printStackTrace();
      }
    }
    if (textureNamefield == null) {
      Class<?> aClass = ReflectionUtil
          .findClazz("net.minecraft.client.renderer.GlStateManager$TextureState", "bfl$r");
      try {
    ...
    if (activeTextureUnitField == null) {
      activeTextureUnitField = ReflectionUtil
          .findField(GlStateManager.class, "activeTextureUnit", "field_179162_o", "o");
    }
    try {
      if (activeTextureUnitField != null) {
  ...
  public void resetColor() {
    if (colorStateObject == null) {
      Class<?> aClass = ReflectionUtil
          .findClazz("net.minecraft.client.renderer.GlStateManager", "bfl");
      Field tmp = null;
      try {
    ...
    if (redColorField == null) {
      Class<?> aClass = ReflectionUtil
          .findClazz("net.minecraft.client.renderer.GlStateManager$Color", "bfl$e");
      try {
