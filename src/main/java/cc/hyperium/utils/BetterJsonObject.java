...
public class BetterJsonObject {
   ...
   * attempts to load it, a new JsonObject will be created if the input is null, empty or cannot be
   * loaded into a json format
   *
  ...
  /**
   * The alternative constructor for the BetterJsonObject class, this uses another JsonObject as the
   * data set. A new JsonObject will be created if the input is null
   *
  ...
  /**
   * The optional string method, returns an empty string if the key is null, empty or the data does
   * not contain the key. This will also return an empty string if the data value is not a string
   *
   ...
   * not contain the key. This will also return the default value if the data value is not a number
   *
   * @param key the key the value will be loaded from
   * @return the value in the json data set or the default if the key cannot be found
   */
  ...
  /**
   * The optional double method, returns 0.0D if the key is null, empty or the data does not contain
   * the key. This will also return 0.0D if the data value is not a string
   *
   * @param key the key the value will be loaded from
   * @return the value in the json data set or empty if the key cannot be found
   */
