...
public class PlayerInteractEvent extends CancellableEvent {
    ...
    public PlayerInteractEvent(EntityPlayer player, Action action, BlockPos pos, World world, EnumFacing face) {
        this(player, action, pos, world, face, null);
    }

    public PlayerInteractEvent(EntityPlayer player, Action action, BlockPos pos, World world, EnumFacing face, Vec3 localPos) {
        this.player = player;
        this.action = action;
        this.pos = pos;
        this.face = face;
