 ...
 */
public class TownAuraParticle implements IParticle {
    @Override
    public EntityFX spawn(World world, double x, double y, double z) {
        ...
        IParticleFactory iParticleFactory = particleMap.get(EnumParticleTypes.TOWN_AURA.getParticleID());
        return iParticleFactory.getEntityFX(EnumParticleTypes.TOWN_AURA.getParticleID(), world, x, y, z, 0.0F, -0.1F, 0.0F, 0);
    }
}
