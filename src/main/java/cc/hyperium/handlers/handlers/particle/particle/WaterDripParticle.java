 ...
 */
public class WaterDripParticle implements IParticle {
  ...
  public EntityFX spawn(World world, double x, double y, double z) {
    ...
    IParticleFactory iParticleFactory = particleMap
        .get(EnumParticleTypes.DRIP_WATER.getParticleID());
    return iParticleFactory
        .getEntityFX(EnumParticleTypes.DRIP_WATER.getParticleID(), world, x, y, z, 0.0F, -0.1F,
            0.0F, 0);
  }
}
