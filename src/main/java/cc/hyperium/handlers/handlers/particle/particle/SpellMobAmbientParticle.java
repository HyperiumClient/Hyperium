 ...
 */
public class SpellMobAmbientParticle implements IParticle {
  ...
  public EntityFX spawn(World world, double x, double y, double z) {
    ...
    IParticleFactory iParticleFactory = particleMap
        .get(EnumParticleTypes.SPELL_MOB_AMBIENT.getParticleID());
    return iParticleFactory
        .getEntityFX(EnumParticleTypes.SPELL_MOB_AMBIENT.getParticleID(), world, x, y, z, 0.0F,
            -0.1F, 0.0F, 0);
  }
}
