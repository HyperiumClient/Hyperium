...
public class ExplosionParticle implements IParticle {
    ...
    public EntityFX spawn(World world, double x, double y, double z) {
        ...
        IParticleFactory iParticleFactory = particleMap.get(EnumParticleTypes.EXPLOSION_NORMAL.getParticleID());
        return iParticleFactory.getEntityFX(EnumParticleTypes.EXPLOSION_NORMAL.getParticleID(), world, x, y, z, 0.0F, -0.1F, 0.0F, 0);
    }
}
