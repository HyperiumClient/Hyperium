 ...
 */
public class SuspendedDepthParticle implements IParticle {
  ...
  public EntityFX spawn(World world, double x, double y, double z) {
    ...
    IParticleFactory iParticleFactory = particleMap
        .get(EnumParticleTypes.SUSPENDED_DEPTH.getParticleID());
    return iParticleFactory
        .getEntityFX(EnumParticleTypes.SUSPENDED_DEPTH.getParticleID(), world, x, y, z, 0.0F, -0.1F,
            0.0F, 0);
  }
}
