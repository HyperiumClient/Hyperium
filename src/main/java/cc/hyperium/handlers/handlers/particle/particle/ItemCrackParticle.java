 ...
 */
public class ItemCrackParticle implements IParticle {
  ...
  public EntityFX spawn(World world, double x, double y, double z) {
    ...
    IParticleFactory iParticleFactory = particleMap
        .get(EnumParticleTypes.ITEM_CRACK.getParticleID());
    return iParticleFactory
        .getEntityFX(EnumParticleTypes.ITEM_CRACK.getParticleID(), world, x, y, z, 0.0F, -0.1F,
            0.0F, 0);
  }
}
