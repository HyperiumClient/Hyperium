 ...
 */
public class HeartParticle implements IParticle {
    @Override
    public EntityFX spawn(World world, double x, double y, double z) {
        ...
        IParticleFactory iParticleFactory = particleMap.get(EnumParticleTypes.HEART.getParticleID());
        return iParticleFactory.getEntityFX(EnumParticleTypes.HEART.getParticleID(), world, x, y, z, 0.0F, -0.1F, 0.0F, 0);
    }
}
