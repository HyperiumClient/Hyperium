 ...
 */
public class VillagerAngryParticle implements IParticle {
  ...
  public EntityFX spawn(World world, double x, double y, double z) {
    ...
    IParticleFactory iParticleFactory = particleMap
        .get(EnumParticleTypes.VILLAGER_ANGRY.getParticleID());
    return iParticleFactory
        .getEntityFX(EnumParticleTypes.VILLAGER_ANGRY.getParticleID(), world, x, y, z, 0.0F, -0.1F,
            0.0F, 0);
  }
}
