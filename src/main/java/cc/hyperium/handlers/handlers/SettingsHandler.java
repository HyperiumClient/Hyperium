  ...
  public SettingsHandler() {
    try {
      ...
      registerCallback(earsField, o -> {
        ...
        if (self == null) {
          GeneralChatHandler.instance().sendMessage(
              "Error: Could not update cosmetic state because your purchase profile is not loaded.");
          return;
        }
        ...
        if (client != null) {
          client.write(
              ServerCrossDataPacket.build(new JsonHolder().put("internal", true).put("ears", yes)));
        }
      });

      String[] hats1 = new String[]{"Tophat", "Fez", "Lego"};
      EnumPurchaseType[] hat2 = new EnumPurchaseType[]{EnumPurchaseType.HAT_TOPHAT,
          EnumPurchaseType.HAT_FEZ, EnumPurchaseType.HAT_LEGO};
      ...
      registerCallback(hats, o -> {
        ...
        JsonHolder put = new JsonHolder().put("internal", true).put("set_hat", true)
            .put("value", none ? "NONE" : parse.toString());
      ...
      customStates.put(companion_type, () -> {
        ...
        if (self != null && (self.hasPurchased(EnumPurchaseType.DRAGON_COMPANION) || self
            .hasPurchased(EnumPurchaseType.HAMSTER_COMPANION))) {
      ...
      registerCallback(companion_type, o -> {
        ...
        JsonHolder put = new JsonHolder().put("internal", true).put("companion", true)
            .put("type", o.toString().equalsIgnoreCase("NONE") ?
      ...
      registerCallback(show_wings_string, o -> {
        try {
          ...
          ServerCrossDataPacket packet = ServerCrossDataPacket
              .build(new JsonHolder().put("internal", true).put("wings_toggle", packetUpdate));
      ...
      registerCallback(show_dragonhead_string, o -> {
        try {
          ...
          ServerCrossDataPacket packet = ServerCrossDataPacket
              .build(new JsonHolder().put("internal", true).put("dragon_head", packetUpdate));
      ...
      registerCallback(Settings.class.getField("WINGS_SCALE"), o -> {
        ...
        if (client != null) {
          client.write(ServerCrossDataPacket
              .build(new JsonHolder().put("internal", true).put("wings_scale", wingScale)));
        }
