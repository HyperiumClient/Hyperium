...
public class DuelsStats extends AbstractHypixelStats {
  ...
  private final String[] tournaments = new String[]{"sw_tournament", "uhc_tournament",
      "sumo_tournament"};
  private final String[] tournament_names = new String[]{"SkyWars Tournament", "UHC Tournament",
      "Sumo Tournament"};
  ...
  public List<StatsDisplayItem> getDeepStats(HypixelApiPlayer player) {
    ...
    JsonHolder stats = player.getStats(GameType.DUELS);
    preview.add(new DisplayLine(""));
    String[] modes = new String[]{"uhc_duel", "uhc_doubles", "sw_duel", "sw_doubles",
        "classic_duel", "op_duel", "combo", "mw_duel", "mw_doubles", "blitz_duels", "potion_duel",
        "sumo_duel"};
    String[] names = new String[]{"UHC Solo", "UHC Doubles", "SW Solo", "SW Doubles",
        "Classic Duel", "OP duel", "Combo", "MegaWalls Solo", "MegaWalls Doubles", "Blitz Solo",
        "Potion Duel", "Sumo"};
    ...
    lines = new ArrayList<>();
    lines.add(
        new String[]{"Mode", "Kills", "Wins", "Deaths", "Losses", "K/D", "W/L", "Best Winstreak"});
