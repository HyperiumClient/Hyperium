...
public class ArenaStats extends AbstractHypixelStats {
  ...
  public List<StatsDisplayItem> getPreview(HypixelApiPlayer player) {
    ...
    int deaths =
        arena.optInt("deaths_1v1") + arena.optInt("deaths_2v2") + arena.optInt("deaths_4v4");
    ...
    int losses =
        arena.optInt("losses_1v1") + arena.optInt("losses_2v2") + arena.optInt("losses_4v4");
    items.add(new DisplayLine(bold("Losses: ", losses), Color.WHITE.getRGB()));
    items.add(new DisplayLine(bold("K/D: ", WebsiteUtils.buildRatio(kills, deaths)),
        Color.WHITE.getRGB()));
    items.add(new DisplayLine(bold("W/L: ", WebsiteUtils.buildRatio(wins, losses)),
        Color.WHITE.getRGB()));
    return items;
  }
  ...
  public List<StatsDisplayItem> getDeepStats(HypixelApiPlayer player) {
    ...
    JsonHolder arena = player.getStats(GameType.ARENA);
    tableItems
        .add(new String[]{"Mode", "Kills", "Deaths", "Wins", "Losses", "Healed", "K/D", "W/L"});
