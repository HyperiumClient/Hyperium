...
public class BedWarsStats extends AbstractHypixelStats {
  ...
  public List<StatsDisplayItem> getPreview(HypixelApiPlayer player) {
    ...
    items.add(
        new DisplayLine(bold("Kills: ", bedwars.optInt("kills_bedwars")), Color.WHITE.getRGB()));
    items.add(
        new DisplayLine(bold("Deaths: ", bedwars.optInt("deaths_bedwars")), Color.WHITE.getRGB()));
    items
        .add(new DisplayLine(bold("Wins: ", bedwars.optInt("wins_bedwars")), Color.WHITE.getRGB()));
    items.add(
        new DisplayLine(bold("Losses: ", bedwars.optInt("losses_bedwars")), Color.WHITE.getRGB()));
    items.add(new DisplayLine(bold("K/D: ",
        WebsiteUtils.buildRatio(bedwars.optInt("kills_bedwars"), bedwars.optInt("deaths_bedwars"))),
        Color.WHITE.getRGB()));
    items.add(new DisplayLine(bold("W/L: ",
        WebsiteUtils.buildRatio(bedwars.optInt("wins_bedwars"), bedwars.optInt("losses_bedwars"))),
        Color.WHITE.getRGB()));
    items.add(new DisplayLine(""));
    items.add(new DisplayLine(bold("Bedwars level: ", WebsiteUtils
        .getBedwarsLevel(bedwars.optInt("Experience") + bedwars.optInt("Experience_new")))));
    ...
    items.add(new DisplayLine(bold("Final K/D: ", WebsiteUtils
        .buildRatio(bedwars.optInt("final_kills_bedwars"),
            bedwars.optInt("final_deaths_bedwars")))));
    items.add(new DisplayLine(bold("Final Kill / Normal deaths: ", WebsiteUtils
        .buildRatio(bedwars.optInt("final_kills_bedwars"), bedwars.optInt("deaths_bedwars")))));
    return items;
  }
  ...
  public List<StatsDisplayItem> getDeepStats(HypixelApiPlayer player) {
    ...
    lines.add(
        new String[]{"Mode", "Kills", "Deaths", "Wins", "Losses", "Final Kills", "Final Deaths",
            "Beds Broken", "K/D", "Final K/D", "W/L"});
    for (int i = 0; i < bedwarsnames.length; i++) {
      lines.add(new String[]{bedwarsnames[i],
          ...
          WebsiteUtils.buildRatio(bedwars.optInt(bedwarsBackend[i] + "_kills_bedwars"),
              bedwars.optInt(bedwarsBackend[i] + "_deaths_bedwars")),
          WebsiteUtils.buildRatio(bedwars.optInt(bedwarsBackend[i] + "_final_kills_bedwars"),
              bedwars.optInt(bedwarsBackend[i] + "_final_deaths_bedwars")),
          WebsiteUtils.buildRatio(bedwars.optInt(bedwarsBackend[i] + "_wins_bedwars"),
              bedwars.optInt(bedwarsBackend[i] + "_losses_bedwars"))
      });
    }
