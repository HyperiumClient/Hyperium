...
public class CVCStats extends AbstractHypixelStats {
  ...
  public List<StatsDisplayItem> getPreview(HypixelApiPlayer player) {
    ...
    items.add(
        new DisplayLine(bold("Headshots: ", stats.optInt("headshot_kills")), Color.WHITE.getRGB()));
  ...
  public List<StatsDisplayItem> getDeepStats(HypixelApiPlayer player) {
    ...
    preview.add(new DisplayLine(bold("Bombs Planted: ", stats.optInt("bombs_planted")),
        Color.WHITE.getRGB()));
    preview.add(new DisplayLine(bold("Bombs Defused: ", stats.optInt("bombs_defused")),
        Color.WHITE.getRGB()));
    preview.add(
        new DisplayLine(bold("Round Wins: ", stats.optInt("round_wins")), Color.WHITE.getRGB()));
    preview.add(
        new DisplayLine(bold("Shots Fired: ", stats.optInt("shots_fired")), Color.WHITE.getRGB()));
