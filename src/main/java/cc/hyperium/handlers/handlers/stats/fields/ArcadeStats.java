...
public class ArcadeStats extends AbstractHypixelStats {
  ...
  public List<StatsDisplayItem> getDeepStats(HypixelApiPlayer player) {
    ...
    items
        .add(new DisplayLine(bold("Bounty Kills: ", arcade.optInt("bounty_kills_oneinthequiver"))));
    ...
    items.add(new DisplayLine(bold("Melee Weapon: ",
        arcade.optString("melee_weapon").toLowerCase(Locale.ENGLISH).replace("_", " "))));
    ...
    items.add(new DisplayLine(
        bold("Total Hole in the Walls Rounds: ", arcade.optInt("rounds_hole_in_the_wall"))));
