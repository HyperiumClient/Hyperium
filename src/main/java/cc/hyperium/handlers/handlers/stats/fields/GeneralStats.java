...
public class GeneralStats extends AbstractHypixelStats {
  ...
  public List<StatsDisplayItem> getPreview(HypixelApiPlayer player) {
    ...
    items.add(new DisplayLine(bold("Achievement Points: ", player.getAchievementPoints()),
        Color.WHITE.getRGB()));
    items.add(
        new DisplayLine(bold("Quest Completed: ", player.getTotalQuests()), Color.WHITE.getRGB()));
    items.add(
        new DisplayLine(bold("Current Coins: ", player.getTotalCoins()), Color.WHITE.getRGB()));
