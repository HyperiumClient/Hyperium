...
public class KeyBindHandler {
  ...
  public KeyBindHandler() {
    ...
    registerKeyBinding(new ArmWaveKeybind());
  ...
  /**
   * Grabs a binding from the registered keybindings list, this is case-insensitive and any key/name
   * may be provided without fear of causing issues
   *
  ...
  /**
   * Registers a Hyperium KeyBinding here & in the game code so it shows up in the controls menu,
   * allowing the user to modify the keybind
   *
  ...
  /**
   * Getter for the all the registered key bindings, this is package private to allow for saving and
   * loading
   *
   * @return the keybinds
   */
